        ...
        <Grid marginTop={12} >
            <Container maxWidth="sm" >
                ...
                <form onSubmit={onSubmit} >
                    ...
                    <TextField style={{ backgroundColor: "#ffffff25" }} value={produto.material} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedProduto(e)} id="material" label="Material" name="material" variant="outlined" margin="normal" fullWidth />
                    <TextField
                    style={{ backgroundColor: "#ffffff25" }}
                    ...
                    <FormControl >
                        ...
                        <Select style={{ backgroundColor: "#ffffff25" }}
